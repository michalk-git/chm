...
private:
	...
	//QP::QTimeEvt m_timeEvt2;

public:
    Philo():QActive(&initial),
...
/*
inline QP::QTimeEvtCtr think_time2() {                                                  //new time interval for time event
	return static_cast<QP::QTimeEvtCtr>((BSP::random() % BSP::TICKS_PER_SEC)
		+  (BSP::TICKS_PER_SEC)/3U);
}
*/
...
Q_STATE_DEF(Philo, thinking) {
    ...
    switch (e->sig) {
        ...
        case Q_ENTRY_SIG: {
			...
			//QActive_postFIFO((QActive*)me, Q_NEW());
			//m_timeEvt2.armX(think_time2(), 0U);
			TableEvt* pe = Q_NEW(TableEvt, HI_SIG);
			pe->philoNum = PHILO_ID(this);
			AO_newAO->POST(pe, this);
        ...
        /*
		//${AOs::Philo::SM::thinking::NEW_SIG}
		case NEW_SIG: {                                                          //new case
			TableEvt* pe = Q_NEW(TableEvt, ENTERED_NEW_SIG);              
			pe->philoNum = PHILO_ID(this);
