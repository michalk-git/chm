...
int main(int argc, char *argv[]) {
	...
	static QP::QEvt const* NewAOQueueSto[N_PHILO];                              //new
	...
	QS_SIG_DICTIONARY(HI_SIG, (void*)0);
	...
	AO_NewAO->start((uint8_t)(N_PHILO + 1U),
		NewAOQueueSto, Q_DIM(NewAOQueueSto),
		(void*)0, 0U);
