...
static char_t const* const NEW_SIG = &"new signal  "[0];                            //new
static char_t const* const HI = &"hi new ao  "[0];
...
Q_STATE_DEF(Table, serving) {
    ...
    switch (e->sig) {
		...
		/*
		case ENTERED_NEW_SIG: { 
			uint8_t n = Q_EVT_CAST(TableEvt)->philoNum;                                  //new case
			BSP::displayPhilStat(n, NEW_SIG);
			status_ = Q_RET_HANDLED;
			break;
		}
		*/
